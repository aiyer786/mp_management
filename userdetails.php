...
<!-------------------------  Student Section------------------------------------------------ -->
  ...
  <form method="POST">
            ...
            <?php 
                if(isset($_POST['mentor'])){
                    ...
                    $query ="INSERT INTO `mentor`(`dept`, `F_name`, `M_name`, `L_name`, `email`, `password`, `contact`) VALUES ('$dept','$F_name','$M_name','$L_name','$email','$password','$contact')";
                    $res = mysqli_query($Connect, $query);
                    if(!$res){
                        echo("<script>alert('Error!! data not inserted into database')</script>");
                    }
                    ...
                    $sr_no=substr(str_repeat(0,4).$sr_no,-4);
                    $m_id="DY{$dept}{$sr_no}";
                    $query="UPDATE `mentor` SET `m_id` = '$m_id' WHERE `mentor`.`email` = '$email'";
  ...
  <div class="mb-3">
            ...
            if (isset($_POST['co_or'])) {
                ...
                $query = "INSERT INTO `coordinator`(`dept`, `F_name`, `M_name`, `L_name`, `email`, `password`, `contact`) VALUES ('$dept','$F_name','$M_name','$L_name','$email','$password','$contact')";
                $res = mysqli_query($Connect, $query);
                ...
                while($row=$res->fetch_assoc())
                    ...
                    $sr_no=substr(str_repeat(0,4).$sr_no,-4);
                    $c_id="DY{$dept}{$sr_no}";
                    $query="UPDATE `coordinator` SET `c_id` = '$c_id' WHERE `coordinator`.`email` = '$email'";
                    $resu = mysqli_query($Connect, $query);
            }
  ...
  <form method="POST">
            ...
            if (isset($_POST['hod'])) {
                ...
                $query = "INSERT INTO `hod`(`dept`, `F_name`, `M_name`, `L_name`, `email`, `password`, `contact`)  VALUES ('$dept','$F_name','$M_name','$L_name','$email','$password','$contact')";
                $res = mysqli_query($Connect, $query);
                if (!$res) {
                    echo ("<script>alert('Error!! data not inserted into database')</script>");
                } else {
                ...
                while($row=$res->fetch_assoc())
                    ...
                    $sr_no=substr(str_repeat(0,4).$sr_no,-4);
                    $c_id="DY{$dept}{$sr_no}";
                    $query="UPDATE `hod` SET `h_id` = '$c_id' WHERE `hod`.`email` = '$email'";
                    $resu = mysqli_query($Connect, $query);
            }
